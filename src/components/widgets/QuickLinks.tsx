import { Store, Wrench, Server, Sparkles } from 'lucide-react';
...
const links = [
  ...
  { icon: Server, label: 'Create your MU Online server with us', subtitle: 'Professional server setup and management', href: '/create-server' },
  { icon: Sparkles, label: 'Arcana Partner Projects', subtitle: 'Join our exclusive partner program', href: '/arcana-projects' },
];
